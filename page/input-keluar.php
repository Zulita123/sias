<?php 
$qw=$db->get('*','surat_keluar','ORDER BY no_agenda DESC');
        $tampil=$qw->fetch();
        $id=$tampil['no_agenda'];
        $ambil=substr($id,4,6);
        $jml=$ambil + 1;
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Surat Keluar<small> (Silakan Isi Form di Bawah Ini</small>)</h4>
                            </div>
                            <div class="card-body m-t-15">
                                <form class="form-horizontal p-t-20" method="POST" enctype="multipart/form-data" action="proses/sim-keluar.php?aksi=simpan">
                                    <div class="form-group row">
                                        <label for="uname" class="col-sm-3 control-label">No Agenda</label>
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input type="text" value="<?php echo $nomot ?>" readonly=""    class="form-control" name="no_agenda" id="no_agenda">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="id_petugas" id="id_petugas" value="<?php echo $_SESSION['id_petugas'] ?>">
                                                <div class="input-group-addon"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row m-b-0">
                                        <div class="offset-sm-3 col-sm-9 ">
                                            ...
                                            <button type="submit" class="btn btn-dark waves-light">Cancel</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
