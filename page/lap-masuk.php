...
<div class="page-wrapper">
    ...
    $_SESSION['cari']=$bulan;
            $qw=$db->get("*","surat_masuk","WHERE month(tanggal_kirim)='$bulan'");
        }else{
            $qw=$db->get("*","surat_masuk","WHERE month(tanggal_kirim)='1'");
            }
               ?>
               <div class="col-sm-12">
                        <div class="card">
        ...
        <td><?php echo$tampil['perihal']; ?></td>
                        ...
                        <script type="text/javascript">
                            function cetak(){
        window.open('http://localhost/sias/page/cetak-masuk.php');
    }
                        </script>
            <!-- End Container fluid  -->
            <!-- footer -->
