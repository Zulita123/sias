                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        $kode=$tampil['terusan'];
                                                        if ($kode=='') {
                                                         echo '<a href="index.php?p=terus-masuk&no_agenda='.$tampil['no_agenda'].'" class="btn btn-primary btn-flat btn-sm">Teruskan</a> |';
                                                        }else{
                                                            echo '<label class="label label-default" style="width: 60px;text-align: center;"><i class="fa fa-check-circle"></i></label> |';
                                                        }
                                                         ?>                                                      
                                                        <a href="index.php?p=lihat-masuk&no_agenda=<?php echo $tampil['no_agenda']; ?>" class="btn btn-warning btn-flat btn-sm">Lihat</a> |
                                                        <a onclick="return confirm('apakah Anda Yakin?')" href="proses/sim-masuk.php?aksi=hapus&no_agenda=<?php echo $tampil['no_agenda']; ?>"  class="btn btn-danger btn-flat btn-sm">Hapus</a>
                                                    </td>
                                                </tr>
                                               <?php } ?>
                                               </tbody>
